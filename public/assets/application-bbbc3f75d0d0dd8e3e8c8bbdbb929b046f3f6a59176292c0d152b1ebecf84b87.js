...
(function() {
  ...
  jQuery(document).on('turbolinks:load', function() {
    var container, messages, messages_loading;
    ...
    if ($('#message-container').length > 0) {
      App.global_chat = App.cable.subscriptions.create({
        ...
        disconnected: function() {
          return console.log('We are now disconnected');
        },
        received: function(data) {
          var div, last_message, output, self_id;
      ...
      return $('#newMessage').submit(function(e) {
        var $this, textarea;
        $this = $(this);
